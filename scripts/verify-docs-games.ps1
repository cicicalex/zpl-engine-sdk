...
.NOTES
  Mirror din workspace: scriptul `tools/sync-zpl-games-to-sdk.ps1` trebuie sa excluda la robocopy doar `zpl-games/README.md` (cale completa), nu pattern-ul global `README.md`, altfel nu se copiaza `examples/README.md`. Linkurile `[docs/README.md](../zpl-engine-sdk/docs/README.md)` din `zpl-games` se convertesc la `[../README.md](../README.md)` pentru `docs/games/`.
